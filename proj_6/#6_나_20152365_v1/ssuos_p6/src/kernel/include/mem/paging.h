...
#define RH_TO_KA(addr) (uint32_t *)((uint32_t)addr - RKERNEL_HEAP_START + KERNEL_ADDR)
#define KA_TO_RH(addr) (uint32_t *)((uint32_t)addr - KERNEL_ADDR + RKERNEL_HEAP_START)

#define VH_TO_KA(addr) (uint32_t *)((uint32_t)addr - VKERNEL_HEAP_START + KERNEL_ADDR)
#define KA_TO_VH(addr) (uint32_t *)((uint32_t)addr - KERNEL_ADDR + VKERNEL_HEAP_START)
